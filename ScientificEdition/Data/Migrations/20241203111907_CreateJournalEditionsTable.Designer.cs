...
namespace ScientificEdition.Data.Migrations
{
    ...
    [Migration("20241203111907_CreateJournalEditionsTable")]
    partial class CreateJournalEditionsTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ScientificEdition.Data.Entities.Article", b =>
                {
                    ...
                    b.Property<Guid?>("JournalEditionId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ScientificEdition.Data.Entities.JournalEdition", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ScientificEdition.Data.Entities.Article", b =>
                {
                    ...
                    b.HasOne("ScientificEdition.Data.Entities.JournalEdition", "JournalEdition")
                        .WithMany("Articles")
                        .HasForeignKey("JournalEditionId")
                        .OnDelete(DeleteBehavior.Restrict);
